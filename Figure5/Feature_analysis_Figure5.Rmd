...
table_SMALL_UP_DNE1DCP2_1$List <- "up dne1.1 dcp2 vs dcp2"

table_SMALL_UP_DNE1DCP2_2 <- Feature[(Feature$Gene_ID %in% SMALL_UP_DNE1DCP2_2$AGI),]
table_SMALL_UP_DNE1DCP2_2$List <- "up dne1.2 dcp2 vs dcp2"
...
table_SMALL_DOWN_DNE1DCP2_1$List <- "down dne1.1 dcp2 vs dcp2"

table_SMALL_DOWN_DNE1DCP2_2 <- Feature[(Feature$Gene_ID %in% SMALL_DOWN_DNE1DCP2_2$AGI),]
table_SMALL_DOWN_DNE1DCP2_2$List <- "down dne1.2 dcp2 vs dcp2"
...
Orderforgraph <- c("xrn4", "dcp2", "up dne1.1 dcp2 vs dcp2", "up dne1.2 dcp2 vs dcp2", "up dne1 dcp2 vs dcp2", "down dne1.1 dcp2 vs dcp2", "down dne1.2 dcp2 vs dcp2", "down dne1 dcp2 vs dcp2", "flowers")
